          ...
          {Object.entries(skills).map(([category, items], catIdx) => {
            ...
            return (
              <motion.div
                ...
                className="group rounded-2xl border border-[var(--border)] bg-[var(--card)] p-6 transition-all hover:border-[var(--accent)]/20 hover:shadow-lg hover:shadow-[var(--accent)]/5"
              >
                <div
                ...
                <div className="flex flex-wrap gap-2">
                  {items.map((skill, i) => (
                    <motion.span
                      ...
                      className="inline-flex items-center gap-2 rounded-xl bg-[var(--muted)] px-3.5 py-2.5 text-sm font-medium transition-colors hover:bg-[var(--accent)]/10 hover:text-[var(--accent)]"
                    >
